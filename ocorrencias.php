...
<body>
						...
						<form class="formocor" action="?p=editar" method="POST" role="form">
							...
							<div class="form-group">
								<div class="col-md-offset-2 col-md-8">
									...
									<input type="text" class="form-control" name="descricao" placeholder="Se for período de inscrição, descrever." />
								</div>
							</div>						
							<div class="form-group">
								<div class="col-md-offset-2 col-md-8">
	...
	//colocar if do cara que esqueceu de marcar	
				...
				if(isset($_POST['inserir'])){
					...
					$sql = "INSERT INTO `sc_ocorrencia` (`local`, `idEvento`, `segunda`, `terca`, `quarta`, `quinta`, `sexta`, `sabado`, `domingo`, `dataInicio`, `dataFinal`, `horaInicio`,`valorIngresso`, `lotacao`, `duracao`,  `publicado`, `horaFinal`, `descricao`) 
					VALUES ('$local', '$id_evento', '$segunda', '$terca', '$quarta', '$quinta', '$sexta', '$sabado', '$domingo', '$data_inicio', '$data_final', '$hora', '$valorIngresso', '$ingressos',  '$duracao',  '1','$horaFinal','$descricao')";	
					$res = $wpdb->query($sql);
				...
				if(isset($_POST['duplicar'])){
					...
					SELECT `local`, `idEvento`, `segunda`, `terca`, `quarta`, `quinta`, `sexta`, `sabado`, `domingo`, `dataInicio`, `dataFinal`, `horaInicio`,`valorIngresso`, `lotacao`, `duracao`,  `publicado`,  `descricao` FROM sc_ocorrencia WHERE `idOcorrencia` = '$id'";
